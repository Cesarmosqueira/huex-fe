...
export class DocumentUnitComponent implements OnInit {
  ...
  saveDocuments() {
    ...
    if (this.documentUnitForm.valid) {
      ...
      documentUnit.fireExtinguisherExpiration = this.pipe.transform(fireExtinguisherExpiration, 'yyyy-MM-ddTHH:mm:ss.sssZ');
      documentUnit.firstAidKitExpiration = this.pipe.transform(firstAidKitExpiration, 'yyyy-MM-ddTHH:mm:ss.sssZ');
      documentUnit.technicalReviewExpiration = this.pipe.transform(technicalReviewExpiration, 'yyyy-MM-ddTHH:mm:ss.sssZ');
      documentUnit.photoTechnicalReview = this.photoTechnicalReviewLocal.replace("data:image/jpeg;base64,", "");
      documentUnit.soatExpiration = this.pipe.transform(soatExpiration, 'yyyy-MM-ddTHH:mm:ss.sssZ');
      documentUnit.photoSoat = this.photoSoatLocal.replace("data:image/jpeg;base64,", "");
      documentUnit.mtcExpiration = this.pipe.transform(mtcExpiration, 'yyyy-MM-ddTHH:mm:ss.sssZ');
      ...
      documentUnit.expirationPolicy = this.pipe.transform(expirationPolicy, 'yyyy-MM-ddTHH:mm:ss.sssZ');
